    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validated = $request->validate([
                ...
                'aur_agn_id' => 'required|integer|exists:tblagencies,agn_id',
                'aur_expertise' => 'required|string|max:255',
                'aur_email' => 'required|email|max:100',
                'aur_birthdate' => 'required|date',
                'aur_contact_no' => 'required|string|max:50',
                'aur_tin' => 'required|string|size:12',
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'aur_expertise' => 'sometimes|required|string|max:255',
                'aur_email' => 'sometimes|required|email|max:100',
                'aur_birthdate' => 'sometimes|required|date',
                'aur_contact_no' => 'sometimes|required|string|max:50',
                'aur_tin' => 'sometimes|required|string|size:12',
