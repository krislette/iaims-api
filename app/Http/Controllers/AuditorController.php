    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validated = $request->validate([
                ...
                'aur_name_middle' => 'nullable|string|max:50',
                'aur_name_prefix' => 'nullable|string|max:20',
                'aur_name_suffix' => 'nullable|string|max:10',
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'aur_name_middle' => 'sometimes|nullable|string|max:50',
                'aur_name_prefix' => 'sometimes|nullable|string|max:20',
                'aur_name_suffix' => 'sometimes|nullable|string|max:10',
                ...
                'aur_birthdate' => 'sometimes|nullable|date',
                ...
                'aur_photo' => 'sometimes|nullable|string|max:255',
